...
async def get_quiz(
    ...
    exclude: List[str] = Query([], description="Pokémon que no pueden ser objetivo"),
    target: Optional[str] = Query(None, description="Objetivo concreto para una pregunta de repaso"),
):
